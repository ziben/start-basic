    ...
    if (navGroupCount === 0) {
      await prisma.navGroup.create({
        data: {
          ...
          navItems: {
            create: [
              { title: '系统概览', url: '/admin/dashboard', icon: 'LayoutDashboard', orderIndex: 0 },
            ],
          },
        },
      })
        ...
        data: {
          ...
          navItems: {
            create: [              
              ...
              { title: '用户管理', url: '/admin/users', icon: 'Users',orderIndex: 2 },
              { title: '会话管理', url: '/admin/session', icon: 'Lock',orderIndex: 3 },
              { title: '系统角色', url: '/admin/rbac/roles', icon: 'Shield',orderIndex: 4 },
              { title: '组织角色', url: '/admin/rbac/org-roles', icon: 'Building',orderIndex: 5 },
              { title: '权限定义', url: '/admin/rbac/permissions', icon: 'Key',orderIndex: 6 },
              { title: '组织管理', url: '/admin/organization', icon: 'Building',orderIndex: 7 },
              { title: '成员管理', url: '/admin/member', icon: 'Users',orderIndex: 8},
              { title: '部门管理', url: '/admin/department', icon: 'Building',orderIndex: 9 },         
            ],
          },
        },
      })

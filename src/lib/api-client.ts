...
export const apiClient = {
  ...
  adminLogs: {
    list: (params: {
      ...
      if (typeof params.actorUserId === 'string' && params.actorUserId.trim() !== '') query.set('actorUserId', params.actorUserId)
      if (typeof params.targetType === 'string' && params.targetType.trim() !== '') query.set('targetType', params.targetType)

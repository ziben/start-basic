    ...
    <ContextMenu>
      <ContextMenuTrigger asChild>
        <div
          ref={setNodeRef}
          style={style}
          className={cn('relative flex-shrink-0 outline-none select-none', isDragging && 'z-50')}
        ...
        >
          <TabsTrigger value={tab.id} asChild>
            <div
              ...
              className={cn(
                'relative h-8 max-w-[180px] min-w-[100px] gap-2 px-3 transition-all duration-200',
                isActive
            ...
            >
              ...
              {tab.closable !== false && (
                <button
                  ...
                  className={cn(
                    'ml-1 shrink-0 rounded-sm p-0.5 opacity-0 transition-opacity group-hover:opacity-100 hover:bg-muted/80',
      ...
      <div className='flex h-11 items-center px-3'>
        <Tabs value={activeTabId || ''} className='w-full overflow-hidden'>
          <TabsList
            ref={scrollRef}
            onWheel={handleWheel}
            className='no-scrollbar h-9 w-full justify-start gap-1 overflow-x-auto bg-transparent p-0'
          >

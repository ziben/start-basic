...
import { mergeRequiredAdminGroups } from '~/modules/admin/shared/sidebar/required-groups'
...
export function AdminSidebar(): ReactElement {
  ...
  const groupsWithLogs: NavGroupType[] = mergeRequiredAdminGroups(baseGroups, fallbackData.navGroups, 'ADMIN')

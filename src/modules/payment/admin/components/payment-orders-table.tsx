...
import { type PaymentOrderFilters, usePaymentOrdersQuery } from '../hooks/use-payment-orders'
...
export function PaymentOrdersTable({ search, navigate }: PaymentOrdersTableProps) {
  ...
  const statusFilter = useMemo(() => {
    ...
    return filter.value[0] as PaymentOrderFilters['status']
  }, [columnFilters])
  ...
  const paymentMethodFilter = useMemo(() => {
    ...
    return filter.value[0] as PaymentOrderFilters['paymentMethod']
  }, [columnFilters])

          ...
          <div className='space-y-3'>
            ...
            <div className='grid grid-cols-2 gap-4 text-sm'>
              <div>
                ...
                <div className='mt-1 font-mono'>{selectedOrder.outTradeNo}</div>
              </div>
              <div>
                <div className='text-muted-foreground'>交易号</div>
                <div className='mt-1 font-mono'>{selectedOrder.transactionId || '-'}</div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className='mt-1 text-lg font-semibold'>¥{selectedOrder.amountYuan}</div>
              </div>
              <div>
          ...
          {selectedOrder.metadata && (
            <>
              ...
              <div className='space-y-3'>
                ...
                <pre className='overflow-x-auto rounded-md bg-muted p-3 text-xs'>{metadataText}</pre>
              </div>
            </>
          )}
        </div>

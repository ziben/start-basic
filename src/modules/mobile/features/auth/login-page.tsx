    ...
    <div className='flex min-h-screen flex-col bg-background p-6'>
      ...
      <main className='flex flex-1 flex-col items-center justify-center gap-8 pb-20'>
        <div className='flex flex-col items-center gap-2 text-center'>
          ...
          <p className='px-8 text-muted-foreground'>请选择登录方式进入 {systemName}</p>
        </div>

        <div className='w-full max-w-sm space-y-4'>
          <WeChatLoginButton
            className='h-12 w-full rounded-full border-none bg-[#07C160] text-lg font-medium text-white hover:bg-[#06AD56]'
            callbackUrl='/m'
          >
            微信一键登录
          </WeChatLoginButton>
          ...
          <div className='relative'>
            ...
            <div className='relative flex justify-center text-xs uppercase'>
              <span className='bg-background px-2 text-muted-foreground'>其他方式</span>
            </div>
          </div>

          <Button variant='outline' className='h-12 w-full rounded-full font-medium' asChild>
      ...
      <footer className='py-6 text-center'>
        <p className='text-xs text-muted-foreground'>
          登录即代表同意 <span className='text-primary hover:underline'>用户协议</span> 和{' '}
          <span className='text-primary hover:underline'>隐私策略</span>
        </p>
      </footer>
    </div>
  )

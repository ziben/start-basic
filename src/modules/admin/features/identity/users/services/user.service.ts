 ...
 * [迁移自 admin/shared/services/user.service.ts]
 */

import prisma from '@/shared/lib/db'
import type { Prisma } from '~/generated/prisma/client'
import { serializeAdminUser, serializeAdminUsers, isValidUserSortField, type PrismaUser } from '~/modules/admin/shared/utils/admin-utils'
...
export const UserService = {
    ...
    async create(input: CreateUserInput, headers?: Headers) {
        try {
            ...
            // 3. 触发用户创建钩子
            try {
                const { fireUserCreatedHooks } = await import('~/modules/admin/shared/lib/user-hooks')

...
const AdminNavItemProvider: React.FC<AdminNavItemProviderProps> = ({ children, initialNavGroupId }) => {
  ...
  const contextValue = useMemo(
    ...
    [isCreateDialogOpen, isEditDialogOpen, isDeleteDialogOpen, selectedNavItem, navGroupId]
  )

  return <AdminNavItemContext.Provider value={contextValue}>{children}</AdminNavItemContext.Provider>
}

 ...
 */
const LOG_EXCLUSIONS = new Set(['ListLogs', 'GetLogDetail', 'ExportLogs'])
...
export async function requirePermission(
  ...
  try {
    ...
    // 检查权限
    const hasPermission = await checkPermission(session.user.id, permission, options, request.headers)

    ...
    <div className='relative min-h-screen overflow-hidden'>
      ...
      <div className='relative container py-12 md:py-24'>
        ...
        <section className='py-14 md:py-20'>
          <div className='mx-auto flex max-w-4xl flex-col items-center text-center'>
            ...
            <div className='mt-10 flex flex-col justify-center gap-4 sm:flex-row'>
              <Link
                to='/sign-up'
                className='inline-flex h-12 items-center justify-center rounded-lg bg-primary px-8 text-sm font-medium text-primary-foreground shadow-lg transition-all hover:scale-105 hover:bg-primary/90'
              >
                立即开始
        ...
        <section className='py-10 md:py-14'>
          <div className='mx-auto max-w-5xl rounded-3xl border bg-background/40 p-8 shadow-2xl backdrop-blur md:p-12'>
            <div className='grid gap-8 md:grid-cols-2 lg:grid-cols-3'>
              <div className='flex flex-col gap-2'>
                ...
                <p className='text-sm text-muted-foreground'>全方位监控指标，确保持续可用与高性能响应。</p>
              </div>

              <div className='rounded-2xl border bg-background/60 p-6 backdrop-blur transition-all hover:shadow-md'>
                <div className='flex items-center justify-between'>
                  <div className='text-xs font-semibold tracking-wider text-muted-foreground uppercase'>Latency</div>
              ...
              <div className='rounded-2xl border bg-background/60 p-6 backdrop-blur transition-all hover:shadow-md'>
                <div className='flex items-center justify-between'>
                  <div className='text-xs font-semibold tracking-wider text-muted-foreground uppercase'>Uptime</div>

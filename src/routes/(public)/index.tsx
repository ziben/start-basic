    ...
    <div className='relative overflow-hidden'>
      <div
        ...
        style={{
          ...
          maskImage:
            'radial-gradient(60% 55% at 50% 20%, rgba(0,0,0,1) 0%, rgba(0,0,0,0) 70%)',
          WebkitMaskImage:
            'radial-gradient(60% 55% at 50% 20%, rgba(0,0,0,1) 0%, rgba(0,0,0,0) 70%)',
        }}
      />
      <div
        className='pointer-events-none absolute left-1/2 top-[-220px] h-[520px] w-[520px] -translate-x-1/2 rounded-full blur-3xl'
        style={{
          background:
      ...
      <div className='container relative py-12 md:py-16'>
        ...
        <section className='py-14 md:py-20'>
          <div className='mx-auto flex max-w-4xl flex-col items-center text-center'>
            ...
            <p className='mt-4 max-w-[46rem] text-pretty text-base text-muted-foreground md:text-lg'>
          ...
          <div className='mx-auto max-w-4xl rounded-2xl border bg-background/40 p-6 backdrop-blur md:p-8'>
            ...
            <div className='mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between'>
              <div className='text-xs text-muted-foreground'>
                Built on TanStack Start · Better Auth · Prisma
              </div>
